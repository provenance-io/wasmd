...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewWasmApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, wasm.EnableAllProposals, EmptyAppOptions{}, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewWasmApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, wasm.EnableAllProposals, EmptyAppOptions{}, fauxMerkleModeOpt)

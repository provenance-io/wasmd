...
func SimulationOperations(app *WasmApp, cdc codec.JSONMarshaler, config simtypes.Config) []simtypes.WeightedOperation {
...
func CheckExportSimulation(
	app *WasmApp, config simtypes.Config, params simtypes.Params,
) error {

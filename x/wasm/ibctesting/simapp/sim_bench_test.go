...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/CosmWasm/wasmd/x/wasm/ibctesting/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
